    ...
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          ...
          <a type="text" @click="open" class="btn">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  methods: {
    ...
    async open() {
      ...
      this.$alert(`<img src=${imgUrl}>`, "请你微信支付", {
        dangerouslyUseHTMLString: true, //把输入的第一个参数作为HTMLs
        confirmButtonText: "已支付成功",
        cancelButtonText: "支付遇见问题",
        showCancelButton: true,
        showClose: false, //不显示右上角的关闭框
        center: true,
